...
!(function (e, t) { typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = t() : typeof define === 'function' && define.amd ? define(t) : (e = e || self).Swiper = t(); }(this, (() => {
  const e = typeof document === 'undefined' ? {
    ...
    updateSlides() {
      const e = this.params; const i = this.$wrapperEl; const s = this.size; const a = this.rtlTranslate; const r = this.wrongRTL; const o = this.virtual && e.virtual.enabled; const l = o ? this.virtual.slides.length : this.slides.length; const d = i.children(`.${this.params.slideClass}`); const h = o ? this.virtual.slides.length : d.length; let p = []; const c = []; const u = []; function v(t) { return !e.cssMode || t !== d.length - 1; } let f = e.slidesOffsetBefore; typeof f === 'function' && (f = e.slidesOffsetBefore.call(this)); let m = e.slidesOffsetAfter; typeof m === 'function' && (m = e.slidesOffsetAfter.call(this)); const g = this.snapGrid.length; const b = this.snapGrid.length; let w = e.spaceBetween; let y = -f; let x = 0; let T = 0; if (void 0 !== s) {
        let E; let S; typeof w === 'string' && w.indexOf('%') >= 0 && (w = parseFloat(w.replace('%', '')) / 100 * s), this.virtualSize = -w, a ? d.css({ marginLeft: '', marginTop: '' }) : d.css({ marginRight: '', marginBottom: '' }), e.slidesPerColumn > 1 && (E = Math.floor(h / e.slidesPerColumn) === h / this.params.slidesPerColumn ? h : Math.ceil(h / e.slidesPerColumn) * e.slidesPerColumn, e.slidesPerView !== 'auto' && e.slidesPerColumnFill === 'row' && (E = Math.max(E, e.slidesPerView * e.slidesPerColumn))); for (var C, M = e.slidesPerColumn, P = E / M, z = Math.floor(h / e.slidesPerColumn), k = 0; k < h; k += 1) {
          ...
          } if ($.css('display') !== 'none') { if (e.slidesPerView === 'auto') { const B = t.getComputedStyle($[0], null); const H = $[0].style.transform; const N = $[0].style.webkitTransform; if (H && ($[0].style.transform = 'none'), N && ($[0].style.webkitTransform = 'none'), e.roundLengths)S = this.isHorizontal() ? $.outerWidth(!0) : $.outerHeight(!0); else if (this.isHorizontal()) { const X = parseFloat(B.getPropertyValue('width')); const V = parseFloat(B.getPropertyValue('padding-left')); const Y = parseFloat(B.getPropertyValue('padding-right')); const F = parseFloat(B.getPropertyValue('margin-left')); const W = parseFloat(B.getPropertyValue('margin-right')); const R = B.getPropertyValue('box-sizing'); S = R && R === 'border-box' ? X + F + W : X + V + Y + F + W; } else { const q = parseFloat(B.getPropertyValue('height')); const j = parseFloat(B.getPropertyValue('padding-top')); const K = parseFloat(B.getPropertyValue('padding-bottom')); const U = parseFloat(B.getPropertyValue('margin-top')); const _ = parseFloat(B.getPropertyValue('margin-bottom')); const Z = B.getPropertyValue('box-sizing'); S = Z && Z === 'border-box' ? q + U + _ : q + j + K + U + _; }H && ($[0].style.transform = H), N && ($[0].style.webkitTransform = N), e.roundLengths && (S = Math.floor(S)); } else S = (s - (e.slidesPerView - 1) * w) / e.slidesPerView, e.roundLengths && (S = Math.floor(S)), d[k] && (this.isHorizontal() ? d[k].style.width = `${S}px` : d[k].style.height = `${S}px`); d[k] && (d[k].swiperSlideSize = S), u.push(S), e.centeredSlides ? (y = y + S / 2 + x / 2 + w, x === 0 && k !== 0 && (y = y - s / 2 - w), k === 0 && (y = y - s / 2 - w), Math.abs(y) < 0.001 && (y = 0), e.roundLengths && (y = Math.floor(y)), T % e.slidesPerGroup == 0 && p.push(y), c.push(y)) : (e.roundLengths && (y = Math.floor(y)), (T - Math.min(this.params.slidesPerGroupSkip, T)) % this.params.slidesPerGroup == 0 && p.push(y), c.push(y), y = y + S + w), this.virtualSize += S + w, x = S, T += 1; }
    ...
    updateSlidesProgress(e) { void 0 === e && (e = this && this.translate || 0); const t = this.params; const i = this.slides; const a = this.rtlTranslate; if (i.length !== 0) { void 0 === i[0].swiperSlideOffset && this.updateSlidesOffset(); let r = -e; a && (r = e), i.removeClass(t.slideVisibleClass), this.visibleSlidesIndexes = [], this.visibleSlides = []; for (let n = 0; n < i.length; n += 1) { const o = i[n]; const l = (r + (t.centeredSlides ? this.minTranslate() : 0) - o.swiperSlideOffset) / (o.swiperSlideSize + t.spaceBetween); if (t.watchSlidesVisibility) { const d = -(r - o.swiperSlideOffset); const h = d + this.slidesSizesGrid[n]; (d >= 0 && d < this.size - 1 || h > 1 && h <= this.size || d <= 0 && h >= this.size) && (this.visibleSlides.push(o), this.visibleSlidesIndexes.push(n), i.eq(n).addClass(t.slideVisibleClass)); }o.progress = a ? -l : l; } this.visibleSlides = s(this.visibleSlides); } },
    updateProgress(e) { if (void 0 === e) { const t = this.rtlTranslate ? -1 : 1; e = this && this.translate && this.translate * t || 0; } const i = this.params; const s = this.maxTranslate() - this.minTranslate(); let a = this.progress; let r = this.isBeginning; let o = this.isEnd; const l = r; const d = o; s === 0 ? (a = 0, r = !0, o = !0) : (r = (a = (e - this.minTranslate()) / s) <= 0, o = a >= 1), n.extend(this, { progress: a, isBeginning: r, isEnd: o }), (i.watchSlidesProgress || i.watchSlidesVisibility) && this.updateSlidesProgress(e), r && !l && this.emit('reachBeginning toEdge'), o && !d && this.emit('reachEnd toEdge'), (l && !r || d && !o) && this.emit('fromEdge'), this.emit('progress', a); },
    ...
    on: {
      init() { this.pagination.init(), this.pagination.render(), this.pagination.update(); }, activeIndexChange() { this.params.loop ? this.pagination.update() : void 0 === this.snapIndex && this.pagination.update(); }, snapIndexChange() { this.params.loop || this.pagination.update(); }, slidesLengthChange() { this.params.loop && (this.pagination.render(), this.pagination.update()); }, snapGridLengthChange() { this.params.loop || (this.pagination.render(), this.pagination.update()); }, destroy() { this.pagination.destroy(); }, click(e) { this.params.pagination.el && this.params.pagination.hideOnClick && this.pagination.$el.length > 0 && !s(e.target).hasClass(this.params.pagination.bulletClass) && (!0 === this.pagination.$el.hasClass(this.params.pagination.hiddenClass) ? this.emit('paginationShow', this) : this.emit('paginationHide', this), this.pagination.$el.toggleClass(this.params.pagination.hiddenClass)); },
    },
  }, {
    name: 'scrollbar',
    params: {
